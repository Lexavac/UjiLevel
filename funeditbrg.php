<?php 
  ...
  if (isset($_POST['simpan'])){ // mengecek apakah $_POST Simpan sudah pernah di buat jika sudah dia akan menampilkan data sesuai dari yang di isi di form
    ...
    $sql = "UPDATE brg SET id_b='$id_b', name='$name', Tall='$Tall', Birth='$Birth', Gender='$Gender', Addres='$Addres', age='$age', grade='$grade', telephone='$telephone', email='$email' WHERE id_s='$id_s'";
